...
Если ты не хочешь ничего собирать сам, открой релиз `v0.1.3`:

- `https://github.com/GradusXaker/m5-flasher/releases/tag/v0.1.3`

Что скачивать:

- `GradusFlasher-Setup-v0.1.3.exe` — обычная установка
- `GradusFlasher-windows-v0.1.3.zip` — portable-версия
...
- Windows installer: `dist\GradusFlasher-Setup-v0.1.3.exe`
